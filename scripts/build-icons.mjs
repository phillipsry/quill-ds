...
export function build() {
  ...
  const body = entries
    ...
    .join('\n')
  return `// GENERATED by scripts/build-icons.mjs — do not edit. Source: @material-symbols/svg-200 (outlined).\nexport const icons = {\n${body}\n}\n`
}

if (import.meta.url === `file://${process.argv[1]}`) {
  writeFileSync(join(root, 'src/components/ui/icons.generated.mjs'), build())
}
